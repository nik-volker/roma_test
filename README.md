# AI-консультант по отношениям (MVP)

Веб-приложение в формате чат-ассистента для поддержки в вопросах отношений. AI-консультант по отношениям определяет состояние, задаёт уточняющие вопросы и рекомендует конкретные техники.
